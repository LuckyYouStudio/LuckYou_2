  ...
  return (
    <main>
      ...
      <div className="grid">
        ...
        {/* FR-C-28 要求的「提前告知」。放在购票卡紧邻处而非页脚，是因为告知只有出现在
            用户掏钱的地方才算数——写在 SPEC 里等于没告知。缓冲区无出口是刻意设计
            （见 SPEC FR-C-28：任何分配规则都会制造捕获动机），因此按已披露的不可抗力
            处理，而不是当作待修缺陷藏起来 */}
        <section className="card" style={{ borderColor: "var(--accent)" }}>
          <h2>⚠️ 风险提示（购票前请读完）</h2>
          <p style={{ fontSize: 13, lineHeight: 1.75, color: "var(--text)" }}>
            本合约<b>没有任何救援后门</b>——没有可升级代理，没有紧急提款，运营方也拿不走
            不属于自己的钱。这是资金安全的前提，但反过来也意味着：<b>一旦出事，没有人能救</b>。
            具体到三种情况：
          </p>
          <ul style={{ fontSize: 13, lineHeight: 1.85, paddingLeft: 20, color: "var(--text)" }}>
            <li>
              开奖卡死超过 <b>30 天</b>的期，任何人都可以作废它，购票者按票款净额取回
              （扣除已计提的抽成）。这条通道是permissionless 的，不依赖运营方还在不在。
            </li>
            <li>
              中奖后必须在 <b>90 天内</b>领取。逾期未领的奖金会被转入滚存缓冲区，
              不再属于你，且<b>无法找回</b>。
            </li>
            <li>
              <b>滚存缓冲区没有退出通道。</b>缓冲区是未分配滚存资金的中转站
              （过期未领奖金、未开出的奖级、超配比被扣留的部分、注资），它唯一的出口
              是「开出新的一期」。因此若彩票<b>永久停摆</b>，缓冲区里的余额会
              <b>永久留在合约中，任何人都取不出来，包括运营方</b>。
              <br />
              这是刻意的取舍，不是遗漏：这笔钱没有干净的原主，而任何「停摆时分给某些人」
              的规则都会被反向利用——往一个注定被作废的期里砸大量票，30 天后票款照常
              全额退回，同时按票数比例吃掉整个缓冲区，成本只有 gas。
              两害相权，我们选择让这笔钱谁也拿不到，并在此提前告知。
            </li>
          </ul>
        </section>
